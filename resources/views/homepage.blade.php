  ...
  <body>
    <div class="flex flex-col justify-center items-stretch w-full">
      <div class="fixed pin-l pin-r pin-t z-20" id="headroom">
        <ul class="flex list-reset font-bold uppercase text-sm justify-end p-8">
          <li class="relative z-20"><a href="#hero" class="no-underline mx-4">Home</a></li>
          <li class="relative z-20"><a href="#experience" class="no-underline mx-4">Experiences</a></li>
          <li class="relative z-20"><a href="#about" class="no-underline mx-4">About</a></li>
          <li class="relative z-20"><a href="#purchase" class="no-underline mx-4">Purchase</a></li>
          <li class="relative z-20"><a href="/admin/login" class="no-underline mx-4">Login</a></li>
        </ul>
      </div>

      <div id="hero"></div>

      <div class="p-8 md:p-12 lg:p-15 mt-10 sm:mt-0 flex justify-between items-center flex-col sm:flex-row">
        <div class="w-full sm:w-3/5 mb-10 sm:mr-10">
          <h3 class="text-blue-dark mb-4">
        ...
        <div class="min-w-xs w-3/5 md:w-3/5 lg:w-3/5 xl:w-2/5 xxl:w-1/5 sm:ml-8">
          TODO
        </div>
      </div>

      <div class="bg-grey-lightest p-8 md:p-12 lg:p-15 mt-10 sm:mt-0 flex justify-between items-center flex-col sm:flex-row w-full" id="experience">
        <div id="experiences"></div>
      </div>

      <div class="p-8 md:p-12 lg:p-15 mt-10 sm:mt-0 w-full" id="pro">
      ...
      <div class="p-8 md:p-12 lg:p-15 mt-10 sm:mt-0 w-full" id="pricing">
        <h2 class="mb-8 text-blue-dark">Pricing</h2>
        ...
        <div class="flex flex-col md:flex-row justify-between align-stretch mb-8">
          ...
          <div class="w-full md:w-1/2 md:pl-4 flex">
            <div class="rounded-sm bg-blue-dark text-white p-8 w-full">
              <h4 class="mb-4">14-Day Cruise</h4>
              <div class="text-center text-5xl font-bold">
                <small class="text-xs align-top mt-4 -mr-3 inline-block">$</small>
                $1,800
                <sub class="text-sm align-baseline inline-block -ml-3">/ person</sub>
              </div>
              <p>Someone is not coming home alive. Have you seen that movie 47 meters down? *Spoilers* Yeah, that one girl totally get's it from the shark. </p>
            </div>
          </div>
        </div>
